...
/*
 메서드 (method)
  ...
  생성자 : 파일명과 클래스 이름과 똑같이 작성을 해줘야하고 객체의 기본 값을 설정하거나 값을 각각 변경해서 사용하는데 쓰이는 메서드 
  	 ...
  	 public 클래스이름(자료형 매개변수 , 자료형 매개변수2) { 
  	 	...
  	 	예를들어 회원가입을 진행할 때 필수로 이름 나이 전화번호 성별 주소는 넣어주고 
  	 			결혼기념을 광고 수신 동의는 선택으로 하고 싶다면 필수로 이름 ~주소를 넣어줌 
 	  	...
 	  	//문자열을 전달 = String 
 	  	  public String  특정행동1(){
 	  	   ...
 	  	   public int 특정행동2(){
 	  	   	...
 	  	   	return 1; //public 옆에 int를 작성했으니 return 담으에 숫자값을 작성 
